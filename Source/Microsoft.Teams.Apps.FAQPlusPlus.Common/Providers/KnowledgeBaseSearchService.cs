...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Common.Providers
{
    ...
    public class KnowledgeBaseSearchService : IKnowledgeBaseSearchService
    {
        ...
        private readonly bool isGCCHighDeployment;
        ...
        /// <param name="isGCCHighDeployment">Represents whether current deployment is GCC high deployment.</param>
        public KnowledgeBaseSearchService(string searchServiceName, string searchServiceQueryApiKey, string searchServiceAdminApiKey, string storageConnectionString, bool isGCCHighDeployment)
        {
            ...
            this.isGCCHighDeployment = isGCCHighDeployment;
        ...
        {
            var searchDnsSuffix = this.isGCCHighDeployment == true ? "search.azure.us" : "search.windows.net";
